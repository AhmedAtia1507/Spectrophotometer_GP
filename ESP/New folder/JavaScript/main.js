  ...
  options: {
    ...
    plugins: {
      crosshair: {
        ...
        callbacks: {
          label: function (item) {
            // Custom label callback to display values where crosshair lines intersect
            var xLabel = item.chart.data.labels[item.index];
            var yLabel = item.formattedValue || item.yLabel;
