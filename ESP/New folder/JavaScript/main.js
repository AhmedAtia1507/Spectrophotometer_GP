...
function startScan(btn) {
  ...
  if (!isScanning) {
    ...
    disableInputs();
    isScanning = true;
    scan(index,SampleID,SampleDecribe); // send index to display message with index
    enableInputs();
    isScanning = false;
  }
...
function changeState(rowIndex, newState, progress) {
  var table = document.getElementById("myTable");
...
// StoreData2("SampleID", xtest, ytest);
              ...
              websocket.onmessage = function (event) {
                ...
                if (myObj.hasOwnProperty('readings')&&myObj.hasOwnProperty('time')) {
                  ...
                  if(myObj.isFirst==true){
                    displayCMD(myObj.name+"    "+myObj.discription,"red",i);
                    displayCMD(myObj.time,"green",i+1);
                    displayCMD(myObj.mode,"blue",i+2);
...
//// Sample xvalues and yvalues arrays
const xvalues2 = [100, 150, 200, 250, 300, 350, 400, 450, 500, 550, 600, 650, 700, 750, 800];
const yvalues2 = [0.021189, 0.021189, 0.021189, 0.021189, 0.021189, 0.021189, 0.021189, 0.021189, 0.021189, 0.021189, 0.021189, 0.021189, 0.021189, 0.021189, 0.021189];
