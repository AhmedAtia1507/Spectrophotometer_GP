...
typedef struct NVIC_Registers
{
    /*
        ...
        3) According to CMSIS Mapping, the interrupt set enable registers are made as 
            array of registers of type u32:
    ...
    */
    volatile u32 ISER[3U];
    volatile u32 reserved_1[29U];
    ...
    */
    volatile u32 ICER[3U];
    volatile u32 reserved_2[29U];
    ...
    */
    volatile u32 ISPR[3U];
    volatile u32 reserved_3[29U];
    ...
    */
    volatile u32 ICPR[3U];
    volatile u32 reserved_4[29U];
    ...
    */
    volatile u32 IABR[3U];
    volatile u32 reserved_5[61U];
