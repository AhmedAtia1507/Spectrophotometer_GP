...
{
	uint16 Enable_Dual_ADD;	//1-Enable	0-Disable
	uint16 Primary_slave_address;
	uint16 Secondary_slave_address;
	uint16 I2C_Addressing_Slave_mode; //@I2C_Addressing_Slave_
};
...
typedef struct
{
	...
	uint16 StretchMode;								//@I2C_StretchMode_
	...
	uint16 I2C_ACK_Control;							/* Enables or disables the acknowledgement
														This parameter can be a value of @I2C_Ack */

	uint16 General_Call_Address_Detection;			//@I2C_ENGC
...
#define I2C_Addressing_Slave_mode_10Bit			(uint16)(1<<15)
