...
//#define HMOTOR_WL_SELECT_STEP_PORT_ID                           MGPIO_PORTB
//#define HMOTOR_WL_SELECT_STEP_PIN_ID                            MGPIO_PIN8

//#define HMOTOR_WL_SELECT_DIR_PORT_ID                            MGPIO_PORTB
//#define HMOTOR_WL_SELECT_DIR_PIN_ID                             MGPIO_PIN5
...
#define HMOTOR4_STEP_PIN_ID                                     MGPIO_PIN8

#define HMOTOR4_DIR_PORT_ID                                     MGPIO_PORTB
#define HMOTOR4_DIR_PIN_ID                                      MGPIO_PIN5
