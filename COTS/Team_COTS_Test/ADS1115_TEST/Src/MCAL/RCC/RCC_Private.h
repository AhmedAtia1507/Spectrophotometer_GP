...
#define RCC_APB2RSTR                                    (*(volatile uint32*)(RCC_REGISTERS_BASE_ADDRESS + 0x0C))
/*APB1 peripheral reset register*/
#define RCC_APB1RSTR                                    (*(volatile uint32*)(RCC_REGISTERS_BASE_ADDRESS + 0x10))
/*AHB peripheral clock enable register*/
#define RCC_AHBENR                                      (*(volatile uint32*)(RCC_REGISTERS_BASE_ADDRESS + 0x14))
/*APB2 peripheral clock enable register*/
#define RCC_APB2ENR                                     (*(volatile uint32*)(RCC_REGISTERS_BASE_ADDRESS + 0x18))
/*APB1 peripheral clock enable register*/
#define RCC_APB1ENR                                     (*(volatile uint32*)(RCC_REGISTERS_BASE_ADDRESS + 0x1C))
