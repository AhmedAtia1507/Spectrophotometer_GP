 ...
 * 
 * @param Copy_u32PriorityGrouping: Interrupt priority grouping
 * @return Std_ReturnType
 * @retval E_OK: Priority Grouping has been set
 * @retval E_NOT_OK: Priority Grouping has not been set   
 */
Std_ReturnType MSCB_u8SetPriorityGrouping(u32 Copy_u32PriorityGrouping)
{
    Std_ReturnType Loc_u8FuncStatus = E_NOT_OK;
    switch(Copy_u32PriorityGrouping)
    {
        ...
        {
            SCB -> AIRCR = Copy_u32PriorityGrouping;
 ...
 */
Std_ReturnType MSCB_u8SetNMIPendingFlag(void)
{
    Std_ReturnType Loc_u8FuncStatus = E_NOT_OK;
 ...
 */
Std_ReturnType MSCB_u8SetSysTickPendingFlag(void)
{
    Std_ReturnType Loc_u8FuncStatus = E_NOT_OK;
 ...
 */
Std_ReturnType MSCB_u8ClearSysTickPendingFlag(void)
{
    Std_ReturnType Loc_u8FuncStatus = E_NOT_OK;
 ...
 */
Std_ReturnType MSCB_u8SetPendSVPendingFlag(void)
{
    Std_ReturnType Loc_u8FuncStatus = E_NOT_OK;
 ...
 */
Std_ReturnType MSCB_u8ClearPendSVPendingFlag(void)
{
    Std_ReturnType Loc_u8FuncStatus = E_NOT_OK;
 ...
 *        
 * @param P_u8ActiveIRQNum: Pointer to pass the IRQ number in it 
 * 
 * @return Std_ReturnType 
 * @retval E_OK: Active IRQ Number is successfully obtained
 * @retval E_NOT_OK: Active IRQ number is not obtained
 */
Std_ReturnType MSCB_u8GetActiveIRQ(u8* P_u8ActiveIRQNum)
{
    Std_ReturnType Loc_u8FuncStatus = E_NOT_OK;
    if(P_u8ActiveIRQNum != NULL)
    {
        u16 Loc_u16ExceptionNum = (SCB -> ICSR) & ((0b111111111) << SCB_ICSR_VECTACTIVE_START);
        *P_u8ActiveIRQNum = (u8)Loc_u16ExceptionNum - 16;
        Loc_u8FuncStatus = E_OK;
    }
    else
    {
 ...
 *          -SysTick
 * 
 * @param Copy_u8SystemHandler: Exception number of System Handler
 * @param Copy_u8SysHandlerPriority: Priority of System Handler to be set
 * 
 * @return Std_ReturnType
 * @retval E_OK: System Handler Priority has been set
 * @retval E_NOT_OK: System Handler Priority has not been set   
 */
Std_ReturnType MSCB_u8SetSystemHandlerPriority(u8 Copy_u8SystemHandler, u8 Copy_u8SysHandlerPriority)
{
    Std_ReturnType Loc_u8FuncStatus = E_NOT_OK;
    if(Copy_u8SysHandlerPriority < 16)
    {
        switch(Copy_u8SystemHandler)
        {
            ...
            {
                SCB -> SHPR[Copy_u8SystemHandler] = (Copy_u8SysHandlerPriority << 4);
                Loc_u8FuncStatus = E_OK;
                break;
            }
            default:
 ...
 */
Std_ReturnType MSCB_u8EnableMemFault(void)
{
    Std_ReturnType Loc_u8FuncStatus = E_NOT_OK;
 ...
 */
Std_ReturnType MSCB_u8EnableBusFault(void)
{
    Std_ReturnType Loc_u8FuncStatus = E_NOT_OK;
 ...
 */
Std_ReturnType MSCB_u8EnableUsageFault(void)
{
    Std_ReturnType Loc_u8FuncStatus = E_NOT_OK;
