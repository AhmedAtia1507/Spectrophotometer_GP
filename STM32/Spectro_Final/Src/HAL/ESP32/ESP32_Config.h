...
#define HESP32_NO_OF_COMMANDS                  					33
#define HESP32_NO_OF_NON_ARG_COMMANDS							18
#define HESP32_NO_OF_ARG_COMMANDS								15	
...
static volatile uint8 HESP32_AvailableTasks[HESP32_NO_OF_COMMANDS][30] =   {	/******************Commands with no arguments******************/
																				...
																				"get-lamp-moter-position",	//send lamp motor current position ---> reply "UV Lamp" or "VI Lamp"
																				...
																				"save-filter-step",			//save the value in the eeprom  ==> respond with "saved" or "failed to save"
																				"save-grating-step",		//save the value in the eeprom  ==> respond with "saved" or "failed to save"
																				"save-grating-wave",		//save the value in the eeprom  ==> respond with "saved" or "failed to save"
																				"save-filter-wave",			//save the value in the eeprom  ==> respond with "saved" or "failed to save"
