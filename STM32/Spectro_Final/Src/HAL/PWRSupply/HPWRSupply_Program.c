...
/**
 * @brief: Array to indicate whether the lamp supply is on or off
 * 
 */
static volatile HPWRSupply_Mode_t glbl_uint8SupplyFlags[HPWRSUPPLY_NO_OF_CONTROL_PINS] = {HPWRSUPPLY_OFF};
/**
 * @brief: Array to save the converted data from ADC to indicate whether lamp is functional or not
 * 
 */
