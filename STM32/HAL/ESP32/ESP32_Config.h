...
static volatile uint8 HESP32_AvailableTasks[HESP32_NO_OF_COMMANDS][26] =   {	/******************Commands with no arguments******************/
																				...
																				"set-lamp-motor-VI",		//set the lamp motor to be in the VI ---> reply: "moved" or "failed to move"
																				"set-lamp-motor-UV",		//set the lamp motor to be in the UV ---> reply: "moved" or "failed to move"
