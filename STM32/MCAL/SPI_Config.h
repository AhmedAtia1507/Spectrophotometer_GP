...
typedef struct
{
	u16	Device_Mode; 						//Specifies the SPI operation mode @ref SPI_Device_Mode
	...
	u16	DataSize; 							//@ref SPI_DataSize
	u16	CLKPolarity; 						//@ref SPI_CLKPolarity
	u16	CLKPhase; 							//@ref SPI_CLKPhase
	u16	NSS; 								//Specifies whether the NSS signal is managed by hardware (NSS pin)
	                                    			// or by software using the SSI bitenable @ref SPI_NSS


	u16	SPI_BAUDRATEPRESCALER; 				/*Specifies the band Rate prescaler value which will be used
	...
	u16	IRQ_Enable; 						//@ref SPI_IRQ_Enable
...
//@ref SPI_IRQ_Enable
#define SPI_IRQ_Enable_NONE 						(u32)(0)
#define SPI_IRQ_Enable_TXEIE 						(u32)(1<<7)	//SPI_CR2 Bit 7 TXEIE buffer empty interrupt
#define SPI_IRQ_Enable_RXNEIE 						(u32)(1<<6)	//SPI_CR2 Bit 6 RXNEIE buffer not empty interrupt
#define SPI_IRQ_Enable_ERRIE 						(u32)(1<<5)	//SPI_CR2 Bit 5 ERRIR: Error interrupt
